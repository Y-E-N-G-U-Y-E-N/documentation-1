...
.. warning::
   * If you set the **Capture Amount Manually** option on Odoo but not on Adyen, Odoo can't detect
     it. Therefore, your authorization request would be automatically approved in an immediate
     capture on Adyen's side.
